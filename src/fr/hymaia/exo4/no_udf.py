...
def main():
    ...
    df_total_price_per_category_per_day.write.csv("data/exo4/total_price_per_category_per_day",
                                                  header=True,
                                                  mode="overwrite")
    df_total_price_per_category_per_day_last_30_days.write.csv("data/exo4/total_price_per_category_per_day_last_30_days",
                                                               header=True,
                                                               mode="overwrite")
